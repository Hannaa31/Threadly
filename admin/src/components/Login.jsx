    ...
    <div className='min-h-screen flex items-center justify-center w-full'>
      ...
      <form onSubmit={onSubmitHandler}>
        <div className='mb-3 min-w-72'>
            ...
            <input onChange={(e)=>setEmail(e.target.value)} value={email} className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none' type="email" placeholder='Enter your email address' />
        </div>
        <div className='mb-3 min-w-72'>
